...
<p align="left">
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons? i=aws,bash,bootstrap,css,discord,bots,django,docker,express,fastapi,figma,flask,firebase,gcp,git,github,gitlab,heroku,html,js,jquery,kubernetes,linux,materialui,matlab,mongodb,mysql,netlify,nodejs,postgres,powershell,py,r,react,regex,sass,sqlite,tailwind,vscode,vite,figma&theme=light" />
  </a>
</p>
